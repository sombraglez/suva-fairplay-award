...
//When you click on the good button
document.getElementById('goodButton').addEventListener('click', function(e){
    document.getElementById('badButton').disabled = true 
    document.getElementById('badButton').classList.add('btnDisabled');
    //Confetti animation
    'use strict';
